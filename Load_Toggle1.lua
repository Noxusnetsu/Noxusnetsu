...
local function Tweenn(instance, properties,style,wa)
...
local TapXd = win:Tap("More")
local Tab = win:Tap("Raid")
...
MainSection:Dropdown("Fast Attack Type",{"Fast","Normal","Slow"},function(value)
...
task.spawn(function()
	...
	MainSection:Toggle("Auto Cake Prince",_G.Settings.Main["Auto Cake Prince"],function(value)
